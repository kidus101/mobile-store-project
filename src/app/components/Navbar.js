...
const Navbar = () => {
  return (
    <div className="max-w-[1000px] mx-auto flex justify-between items-center p-4">
      ...
      {/* Search Input */}
      <div className="bg-white border border-gray-200 flex items-center px-2 w-[100px] sm:w-[200px] lg:w-[400px]">
      ...
      <div className="flex">
        ...
        <div className="ml-3 text-md"> 로그인 / 회원가입</div>
      </div>

      {/* Add a thin line to separate the navbar and the banner here */}
    </div>
  );
};
